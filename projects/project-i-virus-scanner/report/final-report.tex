...
\begin{enumerate}[leftmargin=*]
  ...
  \item Run \texttt{scripts/export\_private\_repo.py} to create the curated
        handoff package.
  ...
  \item Run the private-repository verification commands from
        \texttt{report/submission-package.md}.
