...
- The latest bounded attempts narrow the simple routes: direct maintenance,
  ...
  current-`rdi` argument reuse, post-stream pointer transfer, and BSS-indirect
  dispatch have not produced success.
