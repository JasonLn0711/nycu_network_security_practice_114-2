...
3. [b1_malware.md](b1_malware.md)
4. [b2_environment_variables.md](b2_environment_variables.md)
5. [c1_linux_security_basics.md](c1_linux_security_basics.md)
6. [c2_setuid.md](c2_setuid.md)
7. [c3_access_control_models.md](c3_access_control_models.md)
...
| Original Handout Title | Stored File | Note File | Main Focus / Status |
| --- | --- | --- | --- |
| `1142_535607syllabus.docx` / `Syllabus` | [csic30094-syllabus.docx](../../handouts/csic30094-syllabus.docx) | [csic30094_syllabus.md](csic30094_syllabus.md) | Course facts, grading, references, and weekly dates |
| `A. Introduction.pdf` | [a-introduction.pdf](../../handouts/a-introduction.pdf) | [a_introduction.md](a_introduction.md) | Course structure, prerequisites, grading, and topic map |
| `B1. Malware.pdf` | [b1-malware.pdf](../../handouts/b1-malware.pdf) | [b1_malware.md](b1_malware.md) | Malware history, taxonomy, propagation, stealth, and detection |
| `B2. Environment_Variables.pptx` | [b2-environment-variables.pptx](../../handouts/b2-environment-variables.pptx) | [b2_environment_variables.md](b2_environment_variables.md) | Environment-variable behavior, attack surfaces, and defenses |
| `C1. Linux_Security_Basics.pdf` | [c1-linux-security-basics.pdf](../../handouts/c1-linux-security-basics.pdf) | [c1_linux_security_basics.md](c1_linux_security_basics.md) | Linux identities, permissions, privilege use, and authentication |
| `C2. SetUID.pdf` | [c2-setuid.pdf](../../handouts/c2-setuid.pdf) | [c2_setuid.md](c2_setuid.md) | Privileged programs, Set-UID mechanics, attack surfaces, and safe design |
| `C3. Access Control Models.pdf` | [c3-access-control-models.pdf](../../handouts/c3-access-control-models.pdf) | [c3_access_control_models.md](c3_access_control_models.md) | Security-policy modeling, access matrix, ACLs, capabilities, DAC vs MAC |
...
- Read the original slide deck first for the instructor's framing.
- Use the matching handout note to turn the slides into a concept map.
- Cross-check the weekly notes in `notes/` when you want more narrative explanation or examples.
- Create a new handout note only when you have real explanation, examples, workflows, or exam cues to preserve.
